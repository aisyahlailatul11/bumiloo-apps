            ...
            <div class="col-lg-8 col-left">
                ...
                @php
                    $artikels = [
                        ...
                        ['img' => asset('images/gayahidup.png'), 'title' => 'Gaya hidup sehat saat hamil', 'desc' => 'Panduan gaya hidup sehat untuk ibu hamil.'],
                        ['img' => asset('images/ibuolahraga.png'), 'title' => 'Olahraga yang aman untuk ibu hamil', 'desc' => 'Rekomendasi olahraga yang aman untuk ibu dan bayi.'],
                        ['img' => asset('images/ibukonsul.png'), 'title' => 'Konsultasi rutin dengan dokter dan bidan', 'desc' => 'Konsultasi rutin dengan dokter dan bidan membantu ibu mengetahui perkembangan si kecil.'],
                    ];
                @endphp
