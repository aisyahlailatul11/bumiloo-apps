    ...
    <div class="flex-grow">
        <div class="row">
            ...
            <div class="col-lg-8 col-left">
                ...
                {{-- PERBAIKAN: Menggunakan 4 gambar aslimu di dalam array dummy --}}
                @php
                    $artikels = [
                        ['img' => asset('images/makanansehatbumil.png'), 'title' => 'Tips memilih camilan sehat untuk Bunda', 'desc' => 'Panduan memilih makanan dan nutrisi sehat yang baik dikonsumsi selama masa kehamilan.'],
                        ['img' => asset('images/ibumual.png'), 'title' => 'Alasan mual dan muntah saat hamil', 'desc' => 'Beberapa penyebab terjadinya rasa mual dan muntah pada ibu hamil, beserta cara mengatasinya.'],
                        ['img' => asset('images/ibupusing.png'), 'title' => 'Cara mengatasi sakit kepala', 'desc' => 'Beberapa cara ampuh mengatasi sakit kepala pada ibu hamil.'],
                        ['img' => asset('images/ajakbayingobrol.png'), 'title' => 'Bunda, ajak si kecil bicara', 'desc' => 'Manfaat berkomunikasi dan mengajak janin mengobrol sejak dalam kandungan.'],
                    ];
                @endphp
            ...
            <div class="col-lg-4 col-right">
                ...
                <div class="rc-card bg-white p-4 rounded-4 shadow-sm mb-4 border-0">
                    ...
                    $populer = [
                        ...
                        ['rank' => '02', 'img' => asset('images/ibumual.png'), 'title' => 'Alasan mual dan muntah saat hamil', 'time' => '6 menit yang lalu'],
                        ['rank' => '03', 'img' => asset('images/ibupusing.png'), 'title' => 'Cara mengatasi sakit kepala', 'time' => '6 menit yang lalu'],
                        ['rank' => '04', 'img' => asset('images/ajakbayingobrol.png'), 'title' => 'Bunda, ajak si kecil bicara', 'time' => '6 menit yang lalu'],
                    ];
                    @endphp
