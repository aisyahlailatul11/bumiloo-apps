        ...
        <div class="col-md-6">
            <div class="card card-custom p-4 border-0 shadow-sm">
                <div class="d-flex align-items-center">
                    ...
                    <div>
                        {{-- Mengubah variabel ke Bulan Ini --}}
                        <h2 class="fw-bold mb-0">{{ $jumlahKunjunganBulanIni ?? 0 }}</h2>
        ...
        <div class="col-md-6">
            <div class="card card-custom p-4 border-0 shadow-sm">
                <div class="d-flex align-items-center">
                    ...
                    <div>
                        {{-- Mengubah variabel ke Bulan Ini --}}
                        <h2 class="fw-bold mb-0">{{ $jumlahPersalinanBulanIni ?? 0 }}</h2>
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    // LINE CHART (Kunjungan per bulan) - SUMBU Y DIAKTIFKAN
    new Chart(document.getElementById('kunjunganChart'), {
        ...
        options: {
            ...
            scales: { 
                y: { 
                    display: true, // Diaktifkan kembali
                    beginAtZero: true,
                    ticks: {
                        stepSize: 5, // Angka bulat
                        color: '#6c757d'
                    },
                    grid: {
                        color: 'rgba(0, 0, 0, 0.05)', // Garis bantu horizontal tipis
                        drawBorder: false
                    }
                }, 
                x: { 
    ...
    // LINE CHART (Persalinan per bulan) - SUMBU Y DIAKTIFKAN
